CUDA_VISIBLE_DEVICES=0 python ../main.py --visMode --visDir 'ccdnet2_nogan_faces_nodither' --tDown 8 \
...
CUDA_VISIBLE_DEVICES=0 python ../main.py --visMode --visDir 'ccdnet2_nogan_faces_dither' --tDown 8 \
