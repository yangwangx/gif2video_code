...
parser.add_argument('--subset_eval', default='valid', type=str, choices=['valid', 'test'], help='subset for evaluation')
...
# model
parser.add_argument('--color_model1_file', default='pretrained/ccdnet1_gan_moments_nodither_ep30.pt', type=str, help='')
...
opts.inputRoot = dataRoot + 'gifs/size360_div12_s1_g32_' + opts.dither_mode
...
def create_dataloader():
    trSet = torchdata.gif_moments_ct_train(inputRoot=opts.inputRoot, subset='train', tCrop=opts.tCrop, sCrop=opts.sCrop)
    ...
    evalSet = torchdata.gif_moments_ct_eval(inputRoot=opts.inputRoot, subset=opts.subset_eval, tStride=opts.tStride, tCrop=opts.tCrop)
...
def main_vis():
    ...
    visSet = torchdata.gif_moments_ct_eval(inputRoot=opts.inputRoot, subset='test', tStride=opts.tCrop, tCrop=opts.tCrop)
