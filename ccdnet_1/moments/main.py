...
def create_dataloader():
    trSet = torchdata.gif_moments_train(inputRoot=opts.inputRoot, subset=opts.subset_train, sCrop=opts.PtSz)
    ...
    evalSet = torchdata.gif_moments_eval(inputRoot=opts.inputRoot, subset=opts.subset_eval, tStride=opts.tDown)
...
def main_vis():
    ...
    visSet = torchdata.gif_moments_eval(inputRoot=opts.inputRoot, subset=opts.subset_eval, tStride=opts.tDown)
